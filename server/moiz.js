...
app.post("/adddata", (req, res) => {
    ...
    if (data.hour === "n") {
        ...
        var q = `INSERT INTO arrivalf ( arrival, carrier, flight, gate, terminal, time, status) VALUES ("${arrival}", "${carrier}", "${flight}","${gate}", "${terminal}", "${time}", "${status}")`;
        db.query(q, function (err, result) {
            if (err) console.log(err);
            if (result) console.log('record inserted');
        });
...
app.post("/update", (req, res) => {
    ...
    if (hour === "f") {
        var n = `UPDATE  arrivalf  SET status = "${status}", time = "${time}" WHERE id = "${id}"`;
        db.query(n, function (err, result) {
            if (err) console.log(err);
            if (result) {
                console.log('record inserted');
...
app.post("/deldata", (req, res) => {
    ...
    if (data.hour === "f") {
        var q = `DELETE FROM arrivalf WHERE id = "${id}"`;
...
app.patch("/A1", (req, res) => {
    ...
    if (data.gate === "A1") {
        if (data.enable === "D") {
            ...
            var t = "UPDATE  arrivalf  SET gate = 'A2', status = 'Delayed' WHERE gate = 'A1'";
            db.query(t, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
            ...
            var f = "UPDATE arrivalf  SET gate = 'A1', status = 'On Time' WHERE gate = 'A2' AND status = 'Delayed'";
    ...
    // A2 if----------------------------------------------------------------------------------
        ...
        if (data.enable === "D") {
            ...
            var n = "UPDATE  arrivaln  SET gate = 'A3', status = 'Delayed' WHERE gate = 'A2'";
            db.query(n, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
            ...
            var t = "UPDATE  arrivalf  SET gate = 'A1', status = 'Delayed' WHERE gate = 'A2'";
            db.query(t, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
            ...
            var f = "UPDATE arrivalf  SET gate = 'A2', status = 'On Time' WHERE gate = 'A1' AND status = 'Delayed'";
            db.query(f, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
    ...
    // A3 if---------------------------------------------------------------------------------------
        ...
        if (data.enable === "D") {
            ...
            var t = "UPDATE  arrivalf  SET gate = 'A1', status = 'Delayed' WHERE gate = 'A3'";
            db.query(t, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
            ...
            var f = "UPDATE arrivalf  SET gate = 'A3', status = 'On Time' WHERE gate = 'A1' AND status = 'Delayed'";
            db.query(f, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
...
app.patch("/B1", (req, res) => {
    ...
    if (data.gate === "B1") {
        if (data.enable === "d") {
            ...
            var t = "UPDATE  arrivalf  SET gate = 'B2', status = 'Delayed' WHERE gate = 'B1'";
            db.query(t, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
            ...
            var f = "UPDATE  arrivalf  SET gate = 'B1', status = 'On Time' WHERE gate = 'B2' AND status = 'Delayed'";
            db.query(f, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
    ...
    // B2 if----------------------------------------------------------------------------------
        ...
        if (data.enable === "d") {
            ...
            var t = "UPDATE  arrivalf  SET gate = 'B1', status = 'Delayed' WHERE gate = 'B2'";
            db.query(t, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
            ...
            var f = "UPDATE arrivalf  SET gate = 'B2', status = 'On Time' WHERE gate = 'B1' AND status = 'Delayed'";
            db.query(f, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
    ...
    // B3 if---------------------------------------------------------------------------------------
        ...
        if (data.enable === "d") {
            ...
            var t = "UPDATE  arrivalf  SET gate = 'B1', status = 'Delayed' WHERE gate = 'B3'";
            db.query(t, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
            ...
            var f = "UPDATE arrivalf  SET gate = 'B3', status = 'On Time' WHERE gate = 'B1' AND status = 'Delayed'";
            db.query(f, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
...
app.patch("/C1", (req, res) => {
    ...
    if (data.gate === "C1") {
        ...
        if (data.enable === "dis") {
            ...
            var t = "UPDATE  arrivalf  SET gate = 'C2', status = 'Delayed' WHERE gate = 'C1'";
            db.query(t, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
            ...
            var f = "UPDATE  arrivalf  SET gate = 'C1', status = 'On Time' WHERE gate = 'C2' AND status = 'Delayed'";
            db.query(f, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
    ...
    // C2 if----------------------------------------------------------------------------------
        ...
        if (data.enable === "dis") {
            ...
            var t = "UPDATE  arrivalf  SET gate = 'C1', status = 'Delayed' WHERE gate = 'C2'";
            db.query(t, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
            ...
            var n = "UPDATE arrivaln  SET gate = 'C2', status = 'On Time' WHERE gate = 'C3' AND status = 'Delayed'";
            db.query(n, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
            var t = "UPDATE arrivalt  SET gate = 'C2', status = 'On Time' WHERE gate = 'C1' AND status = 'Delayed'";
            db.query(t, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
            var f = "UPDATE arrivalf  SET gate = 'C2', status = 'On Time' WHERE gate = 'C1' AND status = 'Delayed'";
            db.query(f, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
    ...
    // C3 if---------------------------------------------------------------------------------------
        ...
        if (data.enable === "dis") {
            ...
            var t = "UPDATE  arrivalf  SET gate = 'C1', status = 'Delayed' WHERE gate = 'C3'";
            db.query(t, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
            ...
            var f = "UPDATE arrivalf  SET gate = 'C3', status = 'On Time' WHERE gate = 'C1' AND status = 'Delayed'";
            db.query(f, function (err, result) {
                if (err) console.log(err);
                if (result) console.log('record inserted');
            })
