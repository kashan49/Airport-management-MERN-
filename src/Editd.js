...
export default function Editd() {
  ...
  const Add = async (e) => {
    e.preventDefault();
    console.log(data)
    await axios.post("http://localhost:5010/adddatade", data).then(res => res.msg).then(alert("data added successfuly"))
  }
  ...
  const Delete = async (e) => {
    e.preventDefault();
    console.log(del)
    await axios.post("http://localhost:5010/deldatade", del).then(res => res.msg).then(alert("data deleted successfully"))
  }
  ...
  const Update = async (e) => {
    e.preventDefault();
    console.log(del)
    await axios.post("http://localhost:5010/updatedep", update).then(res => {
      let data = res.data;
