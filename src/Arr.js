...
event.preventDefault();
  ...
  let handleSubmit1 = async (e) => {
    ...
    e.preventDefault();
    await axios.post(' http://localhost:5010/arrivaln', { n: arrival }).then(res=>console.log(res.data)).then(navigate('/List'))
  }
  let handleSubmit2 = async (e) => {
    console.log('hello i am running')
    e.preventDefault();
    await axios.post(' http://localhost:5010/departuren', { n: departure }).then(navigate('/List1'))
  }
